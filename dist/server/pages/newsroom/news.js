...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/newsroom/news.vue?vue&type=template&id=79f251a0



var newsvue_type_template_id_79f251a0_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_vm._ssrNode("<div class=\"area-finder bg_color--5\">", "</div>", [_c(VContainer["a" /* default */], [_c('NewsFinder')], 1)], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"pt-5\">", "</div>", [_c(VContainer["a" /* default */], [_c(VBreadcrumbs["a" /* default */], {
    attrs: {
      "items": _vm.links
    }
...
// CONCATENATED MODULE: ./pages/newsroom/news.vue?vue&type=template&id=79f251a0

// EXTERNAL MODULE: external "vuex"
var external_vuex_ = __webpack_require__(11);

// EXTERNAL MODULE: ./components/finder/NewsFinder.vue + 4 modules
var NewsFinder = __webpack_require__(425);

// EXTERNAL MODULE: ./components/news/New.vue + 4 modules
var New = __webpack_require__(385);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/newsroom/news.vue?vue&type=script&lang=js
...
/* harmony default export */ var newsvue_type_script_lang_js = ({
  ...
  watch: {
    language(val) {
      if (this.pageCharge) {
        this.$router.push(this.$i18n.t('urls.newsroomNews'));
      }
    },
    '$i18n.locale': {
      immediate: true,
      handler(newLocale) {
        this.links = [{
          text: this.$t('breadcrumbs.news.tab1'),
          disabled: false,
          href: this.$i18n.t('urls.newsroomMain')
        }, {
          text: this.$t('breadcrumbs.news.tab2'),
          disabled: true
        }];
      }
    }
  ...
  methods: {
    ...
    list() {
      const me = this;
      this.$axios.get('api/PageInformations/GetPageInformationsByCodeFE/10').then(response => {
...
// CONCATENATED MODULE: ./pages/newsroom/news.vue?vue&type=script&lang=js
 /* harmony default export */ var newsroom_newsvue_type_script_lang_js = (newsvue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(8);

// CONCATENATED MODULE: ./pages/newsroom/news.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  newsroom_newsvue_type_script_lang_js,
  newsvue_type_template_id_79f251a0_render,
  staticRenderFns,
  false,
  injectStyles,
  null,
