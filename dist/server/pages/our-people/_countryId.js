...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/finder/TeamFinder.vue?vue&type=template&id=29cbcd68
...
var TeamFindervue_type_template_id_29cbcd68_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c(VContainer["a" /* default */], [_c(VRow["a" /* default */], {
    ...
    attrs: {
      ...
      "label": _vm.$t('team.searchCountry'),
      "hide-details": ""
    },
    scopedSlots: _vm._u([{
      key: "selection",
    ...
    attrs: {
      "disabled": _vm.isUpdating,
      "items": _vm.lawyerCategories,
      "item-text": "lawyerCategoryName",
      "item-value": "lawyerCategoryId",
      "dense": "",
      "chips": "",
      "small-chips": "",
      "multiple": "",
      ...
      "color": "white",
      "solo": "",
      "prepend-icon": "mdi mdi-briefcase-variant-outline prepend-icon",
      "label": _vm.$t('team.searchRole'),
      "hide-details": ""
    },
    scopedSlots: _vm._u([{
      key: "selection",
      fn: function (data) {
        return [_c(VChip["a" /* default */], _vm._b({
          ...
          on: {
            "click": data.select,
            "click:close": function ($event) {
              return _vm.removeLawyerCategory(data.item);
            }
          }
        }, 'v-chip', data.attrs, false), [_vm.language === 'es' ? _c('span', [_vm._v("\n                  " + _vm._s(data.item.lawyerCategoryName) + "\n                ")]) : _c('span', [_vm._v("\n                  " + _vm._s(data.item.lawyerCategoryNameEn) + "\n                ")])])];
      }
    }, {
      key: "item",
      fn: function (data) {
        return [[_c(VList["a" /* VListItemContent */], [_c(VList["c" /* VListItemTitle */], {
          domProps: {
            "innerHTML": _vm._s(_vm.language === 'es' ? data.item.lawyerCategoryName : data.item.lawyerCategoryNameEn)
          }
        })], 1)]];
      }
    }, {
    ...
    attrs: {
      ...
      "label": _vm.$t('team.searchSolution'),
      "hide-details": ""
    },
    scopedSlots: _vm._u([{
      key: "selection",
...
// CONCATENATED MODULE: ./components/finder/TeamFinder.vue?vue&type=template&id=29cbcd68
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/finder/TeamFinder.vue?vue&type=script&lang=js


/* harmony default export */ var TeamFindervue_type_script_lang_js = ({
  props: ['countryId'],
  data() {
    return {
      autoUpdate: true,
  ...
  watch: {
    ...
    searchName(val) {
      this.filtered(this.createTeamFilter1, '');
    },
    selected1(val) {
      this.filtered(this.createTeamFilter2, '');
    },
    selected2(val) {
      this.filtered(this.createTeamFilter3, '');
    },
    selected3(val) {
      this.filtered(this.createTeamFilter4, '');
    }
  },
  methods: {
    ...Object(external_vuex_["mapMutations"])(['setTeamFilter']),
    ...
    initialize() {
      ...
      this.listLawyerCategories();
      if (this.countryId !== '0') {
        this.selected1.push(parseInt(this.countryId));
        this.createTeamFilter5();
      }
    },
    removeCountry(item) {
      const index = this.selected1.indexOf(item.countryId);
      if (index >= 0) this.selected1.splice(index, 1);
    },
    removeLawyerCategory(item) {
      const index = this.selected2.indexOf(item.lawyerCategoryId);
      if (index >= 0) this.selected2.splice(index, 1);
    },
    removePracticeArea(item) {
      const index = this.selected3.indexOf(item.practiceAreaId);
    ...
    listLawyerCategories() {
      const me = this;
      this.$axios.get('api/LawyerCategories/GetLawyerCategoriesFE').then(response => {
        me.lawyerCategories = response.data;
      }).catch(error => {
        console.log(error);
      });
    },
    ...
    clean() {
      ...
      this.selected3 = [];
      this.selected4 = [];
      this.createTeamFilter1();
      this.createTeamFilter2();
      this.createTeamFilter3();
      this.createTeamFilter4();
    }
  }
});
// CONCATENATED MODULE: ./components/finder/TeamFinder.vue?vue&type=script&lang=js
 /* harmony default export */ var finder_TeamFindervue_type_script_lang_js = (TeamFindervue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(8);

// CONCATENATED MODULE: ./components/finder/TeamFinder.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  finder_TeamFindervue_type_script_lang_js,
  TeamFindervue_type_template_id_29cbcd68_render,
  staticRenderFns,
  false,
  null,
  null,
...
/* harmony default export */ var TeamFinder = __webpack_exports__["default"] = (component.exports);
...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/our-people/_countryId.vue?vue&type=template&id=6875f4c1


var _countryIdvue_type_template_id_6875f4c1_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_vm._ssrNode("<div class=\"area-finder bg_color--5\">", "</div>", [_c(VContainer["a" /* default */], [_c('TeamFinder', {
    attrs: {
      "country-id": _vm.countryId
    }
  })], 1)], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"rn-team-area team-area bg_color--5\">", "</div>", [_c(VContainer["a" /* default */], [_c('LawyerTeam')], 1)], 1)], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/our-people/_countryId.vue?vue&type=template&id=6875f4c1

// EXTERNAL MODULE: external "vuex"
var external_vuex_ = __webpack_require__(11);

// EXTERNAL MODULE: ./components/finder/TeamFinder.vue + 4 modules
var TeamFinder = __webpack_require__(431);

// EXTERNAL MODULE: ./components/team/LawyerTeam.vue + 4 modules
var LawyerTeam = __webpack_require__(432);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/our-people/_countryId.vue?vue&type=script&lang=js



/* harmony default export */ var _countryIdvue_type_script_lang_js = ({
  head() {
    return {
      htmlAttrs: {
  ...
  components: {
    LawyerTeam: LawyerTeam["default"],
    TeamFinder: TeamFinder["default"]
  },
  // props:['countryId'],
  data() {
    return {
  ...
  watch: {
    language(val) {
      if (this.pageCharge) {
        this.$router.push(this.$i18n.t('urls.ourPeople') + '/0');
      }
    }
  },
  async mounted() {},
...
// CONCATENATED MODULE: ./pages/our-people/_countryId.vue?vue&type=script&lang=js
 /* harmony default export */ var our_people_countryIdvue_type_script_lang_js = (_countryIdvue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(8);

// CONCATENATED MODULE: ./pages/our-people/_countryId.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  our_people_countryIdvue_type_script_lang_js,
  _countryIdvue_type_template_id_6875f4c1_render,
  staticRenderFns,
  false,
  injectStyles,
  null,
...
/* harmony default export */ var _countryId = __webpack_exports__["default"] = (component.exports);

/***/ })

};;
//# sourceMappingURL=_countryId.js.map