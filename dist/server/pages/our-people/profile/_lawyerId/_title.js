...
"use strict";
/* WEBPACK VAR INJECTION */(function(URL) {/* harmony import */ var vuex__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(11);
/* harmony import */ var vuex__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(vuex__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _configs_utilities_utilities__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(405);
/* harmony import */ var _contact_ContactLawyer_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(369);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  head() {
    return {
      ...
      meta: [{
        hid: 'description',
        name: 'description',
        content: this.$route.params.language === 'es' ? this.lawyer.firtsName + ' ' + this.lawyer.lastName + ' ' + this.lawyer.offices.countries.countryName + ' ' + this.lawyer.lawyerCategories.lawyerCategoryName : this.lawyer.firtsName + ' ' + this.lawyer.lastName + ' ' + this.lawyer.offices.countries.countryNameEn + ' ' + this.lawyer.lawyerCategories.lawyerCategoryNameEn
      }],
      title: this.$i18n.t('titles.ourPeople')
    };
  },
  components: {
    ContactLawyer: _contact_ContactLawyer_vue__WEBPACK_IMPORTED_MODULE_2__["default"]
  },
  props: ['lawyer'],
  data() {
    return {
  ...
  computed: {
    ...Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapState"])(['language', 'dialogContact'])
  },
  watch: {
    dialog(val) {
      if (!val) {
        this.setDialogContact(false);
      }
    },
    dialogContact(val) {
      if (val) {
  ...
  methods: {
    ...Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapMutations"])(['setDialogContact']),
    openDialog() {
      this.setDialogContact(true);
    },
    onClickDownload() {
      this.isLoading = true;
      this.$axios.post(_configs_utilities_utilities__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].urlReports + 'WebService.asmx/GetPathPdf', {
        lawyerId: this.lawyer.lawyerId,
        // Valor del parámetro lawyerId
        language: this.language // Valor del parámetro language
      }).then(response => {
        this.descargarPDF(_configs_utilities_utilities__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].urlReports + response.data.d);
        // console.log(utilities.urlReports + response.data.d)
    ...
    descargarPDF(url) {
      fetch(url).then(response => response.blob()).then(blob => {
        ...
        link.href = urlBlob;
        link.download = this.lawyer.firtsName + this.lawyer.lastName + 'Profile.pdf';
        link.click();
    ...
    onClickVcard() {
      let str = "";
      this.$axios.get('api/Lawyers/GetLawyersVcardById/' + this.lawyer.lawyerId).then(response => {
        str = response.data;
        console.log(str);
        // Creamos un nuevo Blob con el contenido del vCard
        ...
        // Creamos un enlace y lo configuramos para descargar el archivo vCard
        const link = document.createElement('a');
        link.href = url;
        link.download = 'archivo.vcf';

        // Agregamos el enlace al documento y simulamos el clic para descargar el archivo
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(102)["URL"]))
...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/contact/ContactLawyer.vue?vue&type=template&id=9effe53a



var ContactLawyervue_type_template_id_9effe53a_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c(VRow["a" /* default */], {
    ...
    staticClass: "section-title text-left mb--15 mb_sm--30 mb_md--30"
  }, [_c('h3', {
    staticClass: "heading-title mb-5",
    attrs: {
      "align": "center"
    },
    domProps: {
      ...
      fn: function ({
        ...
        return [_c('form', {
          ...
          attrs: {
            "name": "name",
            "rules": "required",
            "customMessages": _vm.customMessages
          },
          scopedSlots: _vm._u([{
            key: "default",
            fn: function ({
              ...
              return [_c('label', {
                ...
                attrs: {
                  "type": "text",
                  "placeholder": _vm.$t('contactUs.name')
                },
                domProps: {
                  "value": _vm.formData.name
                },
            ...
            fn: function ({
              ...
              return [_c('label', {
                ...
                attrs: {
                  "type": "text",
                  "rules": "required|email",
                  "placeholder": _vm.$t('contactUs.email')
                },
                domProps: {
                  "value": _vm.formData.email
                },
          ...
          scopedSlots: _vm._u([{
            ...
            fn: function ({
              ...
              return [_c('label', {
                ...
                attrs: {
                  "placeholder": _vm.$t('contactUs.message')
                },
                domProps: {
                  "value": _vm.formData.message
                },
          ...
          staticClass: "rn-button-style--2 btn_border btn-size-sm contact-btn",
          attrs: {
            "type": "submit",
            "value": "submit"
          }
        }, [_vm._v("\n          " + _vm._s(_vm.$t('home.contactUs')) + "\n          ")])], 1)];
      }
    }])
  })], 1)])], 1);
};
...
// CONCATENATED MODULE: ./components/contact/ContactLawyer.vue?vue&type=template&id=9effe53a

// EXTERNAL MODULE: external "vee-validate"
var external_vee_validate_ = __webpack_require__(298);

// EXTERNAL MODULE: ./node_modules/vee-validate/dist/vee-validate.full.esm.js
var vee_validate_full_esm = __webpack_require__(354);

// EXTERNAL MODULE: external "vuex"
var external_vuex_ = __webpack_require__(11);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/contact/ContactLawyer.vue?vue&type=script&lang=js



/* harmony default export */ var ContactLawyervue_type_script_lang_js = ({
  props: ['lawyerEmail'],
  components: {
  ...
  computed: {
    ...Object(external_vuex_["mapState"])(['language', 'dialogContact']),
    customMessages() {
      return {
        required: this.$t('contactUs.errorMessages.required'),
        email: this.$t('contactUs.errorMessages.email')
      };
    }
  },
  created() {
  ...
  methods: {
    ...Object(external_vuex_["mapMutations"])(['setDialogContact']),
    onSubmit() {
      const me = this;
      me.$axios.post('api/ContactUs', {
        fullName: me.formData.name,
        email: me.formData.email,
        lawyerEmail: me.lawyerEmail,
        contactMessage: me.formData.message
      }).then(response => {
        me.showSuccessToast();
        this.closeDialog();
      }).catch(error => {
    ...
    list() {
      const me = this;
      this.$axios.get('api/PageInformations/GetPageInformationsByCodeFE/13').then(response => {
    ...
    showSuccessToast() {
      this.$toast.success(this.$i18n.t('common.successMessage'), {
        position: 'top-right',
        timeout: 3000,
        closeOnClick: true,
        pauseOnHover: true,
    ...
    showErrorToast() {
      this.$toast.error(this.$i18n.t('common.errorMessage'), {
        position: 'top-right',
        timeout: 3000,
        closeOnClick: true,
        pauseOnHover: true,
...
// CONCATENATED MODULE: ./components/contact/ContactLawyer.vue?vue&type=script&lang=js
 /* harmony default export */ var contact_ContactLawyervue_type_script_lang_js = (ContactLawyervue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(8);

// CONCATENATED MODULE: ./components/contact/ContactLawyer.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  contact_ContactLawyervue_type_script_lang_js,
  ContactLawyervue_type_template_id_9effe53a_render,
  staticRenderFns,
  false,
  null,
  null,
...
/* harmony default export */ var ContactLawyer = __webpack_exports__["default"] = (component.exports);
...
var add = __webpack_require__(6).default
module.exports.__inject__ = function (context) {
  add("6173dea2", content, true, context)
};
...
"use strict";
const url =  false ? undefined : 'https://apisite.ariaslaw.com/';
const urlReports =  false ? undefined : 'https://apisite.ariaslaw.com/print/';
/* harmony default export */ __webpack_exports__["a"] = ({
  url,
  urlReports,
  jsonToArray(json) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_HeaderProfile_vue_vue_type_style_index_0_id_3d425713_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(381);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_HeaderProfile_vue_vue_type_style_index_0_id_3d425713_prod_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_HeaderProfile_vue_vue_type_style_index_0_id_3d425713_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_HeaderProfile_vue_vue_type_style_index_0_id_3d425713_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_HeaderProfile_vue_vue_type_style_index_0_id_3d425713_prod_lang_css__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".disabled-link{cursor:default;opacity:.5;pointer-events:none}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
...
var VThemeProvider = __webpack_require__(312);
...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/team/HeaderProfile.vue?vue&type=template&id=3d425713
...
var HeaderProfilevue_type_template_id_3d425713_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c(VRow["a" /* default */], {
    staticClass: "mt--0"
    ...
    staticClass: "pt-10 pb-5 bg_color--1"
  }, [_c('div', {
    staticClass: "contact-form--2"
  }, [_c(VContainer["a" /* default */], [_c('ContactLawyer', {
    attrs: {
      "lawyer-email": _vm.lawyer.email
    }
    ...
    staticClass: "heading-title subtitle-of",
    domProps: {
      "innerHTML": _vm._s(_vm.language === 'es' ? _vm.lawyer.offices.countries.countryName : _vm.lawyer.offices.countries.countryNameEn)
    }
  }), _vm._v(" "), _c('h2', {
    staticClass: "heading-title title-ly",
    domProps: {
      "innerHTML": _vm._s(_vm.lawyer.firtsName + ' ' + _vm.lawyer.lastName)
    }
  }), _vm._v(" "), _c(VDivider["a" /* default */]), _vm._v(" "), _c('h3', {
    staticClass: "heading-title subtitle-des",
    domProps: {
      "innerHTML": _vm._s(_vm.language === 'es' ? _vm.lawyer.lawyerCategories.lawyerCategoryName : _vm.lawyer.lawyerCategories.lawyerCategoryNameEn)
    }
  })], 1), _vm._v(" "), _c('div', {
    ...
    attrs: {
      "href": _vm.lawyer.socialProfessionalNetwork,
      "target": "_blank"
    }
  }, [_c('i', {
    ...
    staticClass: "heading-title subtitle-des"
  }, [_vm._v(_vm._s(_vm.lawyer.email))])]), _vm._v(" "), _c('div', {
    staticClass: "button-group mt--5"
  }, [_c('a', {
    staticClass: "rn-button-style--2 btn_border btn-size-sm bt-lawyer",
    attrs: {
      "href": "#"
    },
    on: {
  ...
  }, [_vm._v("\n              " + _vm._s(_vm.$t('detailTeam.btnContact')) + "\n            ")]), _vm._v(" "), _c('a', {
    staticClass: "rn-button-style--2 btn_border btn-size-sm bt-lawyer",
    class: {
      'disabled-link': _vm.isLoading
    },
    on: {
  ...
  }), _vm._v("\n\n              " + _vm._s(_vm.$t('detailTeam.btnBio')) + "\n            ")], 1), _vm._v(" "), _c('a', {
    staticClass: "rn-button-style--2 btn_border btn-size-sm bt-lawyer hidden-sm-and-down",
    on: {
      "click": _vm.onClickVcard
    }
  }, [_vm._v("\n              " + _vm._s(_vm.$t('detailTeam.btnVcard')) + "\n            ")]), _vm._v(" "), _c('a', {
    staticClass: "rn-button-style--2 btn_border btn-size-sm bt-lawyer hidden-md-and-up",
    attrs: {
      "href": _vm.lawyer.vcardUrlMobile
    }
  }, [_vm._v("\n              " + _vm._s(_vm.$t('detailTeam.btnVcard')) + "\n            ")])])])]), _vm._v(" "), _c(VCol["a" /* default */], {
    staticClass: "col-content qr",
    attrs: {
      "lg": "2",
      "md": "2",
      "sm": "2",
...
// CONCATENATED MODULE: ./components/team/HeaderProfile.vue?vue&type=template&id=3d425713

// EXTERNAL MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/team/HeaderProfile.vue?vue&type=script&lang=js
var HeaderProfilevue_type_script_lang_js = __webpack_require__(365);

// CONCATENATED MODULE: ./components/team/HeaderProfile.vue?vue&type=script&lang=js
 /* harmony default export */ var team_HeaderProfilevue_type_script_lang_js = (HeaderProfilevue_type_script_lang_js["a" /* default */]); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(8);

// CONCATENATED MODULE: ./components/team/HeaderProfile.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  team_HeaderProfilevue_type_script_lang_js,
  HeaderProfilevue_type_template_id_3d425713_render,
  staticRenderFns,
  false,
  injectStyles,
  null,
...
/* harmony default export */ var HeaderProfile = __webpack_exports__["default"] = (component.exports);

/* nuxt-component-imports */
installComponents(component, {ContactLawyer: __webpack_require__(369).default})
...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/our-people/profile/_lawyerId/_title.vue?vue&type=template&id=1f28d35f



var _titlevue_type_template_id_1f28d35f_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _vm.pageCharge ? _c('div', [_c(VContainer["a" /* default */], {
    staticClass: "pt-5 pb-5"
  }, [_c(VBreadcrumbs["a" /* default */], {
    attrs: {
      "items": _vm.links
    }
  })], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"rn-lawyer-area\">", "</div>", [_c(VContainer["a" /* default */], [_c('HeaderProfile', {
    attrs: {
      "lawyer": _vm.lawyer
    }
  })], 1)], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"rn-lawyer-area-content bg_color--5 pt-10 pb-10\">", "</div>", [_c(VContainer["a" /* default */], [_c('ContentProfile', {
    attrs: {
      "lawyer": _vm.lawyer
    }
  })], 1)], 1)], 2) : _vm._e();
...
// CONCATENATED MODULE: ./pages/our-people/profile/_lawyerId/_title.vue?vue&type=template&id=1f28d35f

// EXTERNAL MODULE: external "vuex"
var external_vuex_ = __webpack_require__(11);

// EXTERNAL MODULE: ./components/team/HeaderProfile.vue + 4 modules
var HeaderProfile = __webpack_require__(428);

// EXTERNAL MODULE: ./components/team/ContentProfile.vue + 4 modules
var ContentProfile = __webpack_require__(429);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/our-people/profile/_lawyerId/_title.vue?vue&type=script&lang=js
...
/* harmony default export */ var _titlevue_type_script_lang_js = ({
  ...
  components: {
    HeaderProfile: HeaderProfile["default"],
  ...
  watch: {
    language(val) {
      if (this.pageCharge) {
        this.$router.push(this.$i18n.t('urls.profile') + `/${this.lawyerId}/${this.createUrlComplement(this.lawyer)}`);
      }
    },
    '$i18n.locale': {
      immediate: true,
      handler(newLocale) {
        this.links = [{
          text: this.$t('breadcrumbs.detailTeam.tab1'),
          disabled: false,
          href: this.$i18n.t('urls.ourPeople') + '/0'
        }, {
          text: this.$t('breadcrumbs.detailTeam.tab2'),
          disabled: true
        }];
      }
    }
  ...
  methods: {
    ...
    async initialize() {
      this.list();
      await this.listLawyer();
    },
    list() {
      const me = this;
      this.$axios.get('api/PageInformations/GetPageInformationsByCodeFE/8').then(response => {
        me.dataPage = response.data[0];
        // General information
    ...
    async listLawyer() {
      const me = this;
      await this.$axios.get('api/Lawyers/GetLawyersByIdFE/' + this.lawyerId).then(response => {
        me.lawyer = response.data;
      }).catch(error => {
        console.log(error);
      });
    },
...
// CONCATENATED MODULE: ./pages/our-people/profile/_lawyerId/_title.vue?vue&type=script&lang=js
 /* harmony default export */ var _lawyerId_titlevue_type_script_lang_js = (_titlevue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(8);

// CONCATENATED MODULE: ./pages/our-people/profile/_lawyerId/_title.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  _lawyerId_titlevue_type_script_lang_js,
  _titlevue_type_template_id_1f28d35f_render,
  staticRenderFns,
  false,
  injectStyles,
  null,
