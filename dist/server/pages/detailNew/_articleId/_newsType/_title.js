...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/detailNew/_articleId/_newsType/_title.vue?vue&type=template&id=250e8eac
var render = function render() {
  ...
  return _c('DetailNew', {
    attrs: {
      "code": _vm.articleId,
      "links": _vm.links[_vm.newsType - 1],
      "news-type": _vm.newsType
    }
  });
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/detailNew/_articleId/_newsType/_title.vue?vue&type=template&id=250e8eac

// EXTERNAL MODULE: external "vuex"
var external_vuex_ = __webpack_require__(11);

// EXTERNAL MODULE: ./components/news/DetailNew.vue + 4 modules
var DetailNew = __webpack_require__(438);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/detailNew/_articleId/_newsType/_title.vue?vue&type=script&lang=js
...
/* harmony default export */ var _titlevue_type_script_lang_js = ({
  ...
  // props: ['articleId', 'newsType'],
  components: {
    DetailNew: DetailNew["default"]
  },
    ...
    '$i18n.locale': {
      ...
      handler(newLocale) {
        this.links = [[{
          ...
          disabled: false,
          href: this.$i18n.t('urls.newsroomNews')
        }, {
          text: this.$t('breadcrumbs.news.tab3'),
          disabled: true
        }], [{
          ...
          disabled: false,
          href: this.$i18n.t('urls.newsroomKnowledgecenter')
        }, {
          text: this.$t('breadcrumbs.knowledge.tab3'),
          disabled: true
        }], [{
          ...
          text: this.$t('breadcrumbs.newsletter.tab4'),
          disabled: true
        }]];
      }
    }
  ...
  methods: {
    ...
    async list() {
      ...
      await this.$axios.get('api/PageInformations/GetPageInformationsByCodeFE/' + type).then(response => {
...
// CONCATENATED MODULE: ./pages/detailNew/_articleId/_newsType/_title.vue?vue&type=script&lang=js
 /* harmony default export */ var _newsType_titlevue_type_script_lang_js = (_titlevue_type_script_lang_js); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(8);

// CONCATENATED MODULE: ./pages/detailNew/_articleId/_newsType/_title.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  _newsType_titlevue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
